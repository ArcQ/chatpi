defmodule Chatpi.Repo.Migrations.CreateMessage do
  ...
  def change do
    create table(:message, primary_key: false) do
      ...
      add :text, :text
      add :user_id, references(:chatpi_user, column: :auth_key, type: :string, on_delete: :nothing, on_update: :update_all)
      add :chat_id, references(:chat, type: :uuid, on_delete: :nothing, on_update: :update_all)
      add :seen_by_id, references(:chatpi_user, type: :uuid, on_delete: :nothing), null: true, default: nil
